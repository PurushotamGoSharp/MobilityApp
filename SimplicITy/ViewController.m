...
- (void)setTabImageForColorIndex:(NSInteger)colorIndex onTabBar:(UITabBar *)tabBar;
{
    ...
    NSString *imageName0 = [NSString stringWithFormat:@"Commercial-0%i.png", imageIndex];
    NSString *imageName1 = [NSString stringWithFormat:@"Dwelling-0%i.png", imageIndex];
    NSString *imageName2 = [NSString stringWithFormat:@"Message-0%i.png", imageIndex];
    NSString *imageName3 = [NSString stringWithFormat:@"Spanner-0%i.png", imageIndex];
    NSString *imageName4 = [NSString stringWithFormat:@"TipsIcon-0%i.png", imageIndex];
