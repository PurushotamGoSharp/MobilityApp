...
+ (NSString *)formatDateForTimeType:(NSDate *)date
{
    ...
    formatterObj.dateFormat = @"yyyy-MM-dd";
    NSString *dateString = [formatterObj stringFromDate:date];
    
    formatterObj.dateFormat = @"HH:mm:ss";
    NSString *timeString = [formatterObj stringFromDate:date];
